package nl.jorisdormans.phantomGUI
{
   ...
   public class PhantomComboBox extends PhantomEditBox
   {
      ...
      private var _border:nl.jorisdormans.phantomGUI.PhantomBorder;
      
      private var _selectBox:nl.jorisdormans.phantomGUI.PhantomSelectBox;
      
      private var _button:nl.jorisdormans.phantomGUI.PhantomButton;
      ...
      public function PhantomComboBox(param1:String, param2:DisplayObjectContainer, param3:Stage, param4:Number, param5:Number, param6:Number = 88, param7:Number = 24, param8:Boolean = true, param9:Boolean = true)
      {
         ...
         this._button = new nl.jorisdormans.phantomGUI.PhantomButton("",this.showSelect,this,param6 - param7,0,param7 - 2,param7 - 2,param8,param9);
         this._button.glyph = PhantomGlyph.ARROW_DOWN;
         this._border = new nl.jorisdormans.phantomGUI.PhantomBorder(param3,getStageX(),getStageY() + param7,param6,5 * 20 + 4,false);
         this._selectBox = new nl.jorisdormans.phantomGUI.PhantomSelectBox(this._border,2,2,param6 - 4,5 * 20);
         this._selectBox.onSelect = this.doSelect;
         _textField.addEventListener(KeyboardEvent.KEY_DOWN,this.onKeyDown);
         _textField.type = TextFieldType.DYNAMIC;
      }
      
      private function doSelect(param1:nl.jorisdormans.phantomGUI.PhantomSelectBox) : void
      {
      ...
      private function showSelect(param1:nl.jorisdormans.phantomGUI.PhantomButton) : void
      {
