package nl.jorisdormans.phantomGUI
{
   ...
   public class PhantomSelectBox extends PhantomPanel
   {
      ...
      private var _cells:Vector.<nl.jorisdormans.phantomGUI.PhantomSelectCell>;
      ...
      public function PhantomSelectBox(param1:DisplayObjectContainer, param2:Number, param3:Number, param4:Number, param5:Number, param6:Boolean = true, param7:Boolean = true)
      {
         ...
         checkSize();
         this._cells = new Vector.<nl.jorisdormans.phantomGUI.PhantomSelectCell>();
      ...
      {
         scrollTo(0,0);
         this._cells.push(new nl.jorisdormans.phantomGUI.PhantomSelectCell(param1,this.changeCell,this,0,this._cells.length * this.cellHeight,_controlWidth - PhantomVerticalScrollbar.BARSIZE,this.cellHeight,showing,enabled));
         this._cells[this._cells.length - 1].index = this._cells.length - 1;
         checkSize();
         scrollTo(0,Math.max(0,this._cells.length * 20 - _controlHeight));
      }
      
      private function changeCell(param1:nl.jorisdormans.phantomGUI.PhantomSelectCell) : void
      {
         if(param1.selected)
         {
      ...
      {
         var _loc2_:nl.jorisdormans.phantomGUI.PhantomSelectCell = null;
      ...
      public function setOptions(param1:Vector.<String>) : void
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            {
               this._cells.push(new nl.jorisdormans.phantomGUI.PhantomSelectCell(param1[_loc3_],this.changeCell,this,0,_loc3_ * this.cellHeight,_controlWidth - PhantomVerticalScrollbar.BARSIZE,this.cellHeight,showing,enabled));
