package nl.jorisdormans.phantomGUI
{
   ...
   public class PhantomPanel extends PhantomControl
   {
      ...
      private var _scrollH:nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar;
      
      private var _scrollV:nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar;
      ...
      override public function setSize(param1:Number, param2:Number) : void
      {
         ...
         {
            _loc7_ = nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar.BARSIZE;
         }
         if(_loc5_ > param2 - _loc7_ || this.verticalScrollBarAlwaysVisible)
         {
            _loc6_ = nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar.BARSIZE;
         }
         ...
         if(_loc7_ > 0)
         {
            ...
            {
               this._scrollH = new nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar(this._scrollX,Math.round(_loc4_),Math.round(_controlWidth - _loc6_),_parent,_controlX,_controlY + _controlHeight - nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar.BARSIZE,_controlWidth - _loc6_,showing,enabled);
               this._scrollH.onChange = this.moveChildren;
            }
            else
            {
               this._scrollH.x = _controlX;
               this._scrollH.y = _controlY + _controlHeight - nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar.BARSIZE;
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               this._scrollV = new nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar(this._scrollY,Math.round(_loc5_),Math.round(_controlHeight - _loc7_),_parent,_controlX + _controlWidth - nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar.BARSIZE,_controlY,_controlHeight - _loc7_,showing,enabled);
               this._scrollV.onChange = this.moveChildren;
            }
            else
            {
               this._scrollV.x = _controlX + _controlWidth - nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar.BARSIZE;
         ...
         if(_loc7_ > 0 && _loc6_ > 0)
         {
            ...
            this._filler.x = x + _controlWidth - nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar.BARSIZE;
            this._filler.y = y + _controlHeight - nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar.BARSIZE;
            this._filler.graphics.clear();
            this._filler.graphics.beginFill(PhantomGUISettings.colorSchemes[colorScheme].colorFaceDisabled);
            this._filler.graphics.drawRect(0,0,nl.jorisdormans.phantomGUI.PhantomVerticalScrollbar.BARSIZE,nl.jorisdormans.phantomGUI.PhantomHorizontalScrollbar.BARSIZE);
