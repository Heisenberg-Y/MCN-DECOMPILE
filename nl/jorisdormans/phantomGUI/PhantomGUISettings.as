package nl.jorisdormans.phantomGUI
{
   ...
   public class PhantomGUISettings
   {
      ...
      public static var colorSchemes:Vector.<nl.jorisdormans.phantomGUI.PhantomColorScheme> = new Vector.<nl.jorisdormans.phantomGUI.PhantomColorScheme>();
      ...
      {
         colorSchemes.push(new nl.jorisdormans.phantomGUI.PhantomColorScheme());
      }
