package nl.jorisdormans.phantomGUI
{
   ...
   public class PhantomVerticalScrollbar extends PhantomControl
   {
      ...
      private var _handle:nl.jorisdormans.phantomGUI.PhantomDragHandle;
      
      public var onChange:Function;
      
      private var _down:nl.jorisdormans.phantomGUI.PhantomButton;
      
      private var _up:nl.jorisdormans.phantomGUI.PhantomButton;
      ...
      public function PhantomVerticalScrollbar(param1:int, param2:int, param3:int, param4:DisplayObjectContainer, param5:Number, param6:Number, param7:Number, param8:Boolean = true, param9:Boolean = true)
      {
         ...
         this._down = new nl.jorisdormans.phantomGUI.PhantomButton("",this.doDown,this,0,0,BARSIZE - 1,BARSIZE - 1,param8,param9);
         this._down.glyph = PhantomGlyph.ARROW_UP;
         this._up = new nl.jorisdormans.phantomGUI.PhantomButton("",this.doUp,this,0,_controlHeight - BARSIZE,BARSIZE - 1,BARSIZE - 1,param8,param9);
         this._up.glyph = PhantomGlyph.ARROW_DOWN;
         this._handle = new nl.jorisdormans.phantomGUI.PhantomDragHandle(this,0,BARSIZE - 1,BARSIZE - 1,this.realHandleSize,0,0,BARSIZE - 1,_controlHeight - BARSIZE - this.realHandleSize - 1,this.doChange,param8,param9);
      }
      
      private function doDown(param1:nl.jorisdormans.phantomGUI.PhantomButton) : void
      {
         this._handle.moveBy(0,-(this.handleSize - 1) * (this.realValueSize / (this.maxValue - this.handleSize)));
      }
      
      private function doUp(param1:nl.jorisdormans.phantomGUI.PhantomButton) : void
      {
         this._handle.moveBy(0,(this.handleSize - 1) * (this.realValueSize / (this.maxValue - this.handleSize)));
      }
