package nl.jorisdormans.graph
{
   ...
   public class Graph extends EventDispatcher
   {
      ...
      public var elements:Vector.<nl.jorisdormans.graph.GraphElement>;
      
      public var grammar:nl.jorisdormans.graph.GraphGrammar;
      
      public function Graph()
      {
         super();
         this.elements = new Vector.<nl.jorisdormans.graph.GraphElement>();
         this.clear();
      }
      
      public function addElement(param1:nl.jorisdormans.graph.GraphElement) : void
      {
         param1.graph = this;
         this.elements.push(param1);
      }
      
      public function removeElement(param1:nl.jorisdormans.graph.GraphElement) : void
      {
      ...
      public function addConnection(param1:String, param2:Vector3D, param3:Vector3D) : GraphConnection
      {
		...
		// Note: the decompile code will lead to compile error, just rewrite it into the below code
         //(_loc5_ = new _loc4_ = this.grammar.getConnectionType(param1).connectionClass()).type = _loc4_;
		 var temp = this.grammar.getConnectionType(param1);
		 _loc4_ = temp;
		 _loc5_ = new _loc4_.connectionClass();
		 _loc5_.type = _loc4_;
