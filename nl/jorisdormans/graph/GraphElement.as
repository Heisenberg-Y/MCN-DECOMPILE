package nl.jorisdormans.graph
{
   ...
   public class GraphElement extends EventDispatcher
   {
      ...
      public var graph:nl.jorisdormans.graph.Graph;
      
      public var inputs:Vector.<nl.jorisdormans.graph.GraphConnection>;
      
      public var outputs:Vector.<nl.jorisdormans.graph.GraphConnection>;
      
      public function GraphElement()
      {
         super();
         this.id = -1;
         this.inputs = new Vector.<nl.jorisdormans.graph.GraphConnection>();
         this.outputs = new Vector.<nl.jorisdormans.graph.GraphConnection>();
      }
      ...
      public function removeOutput(param1:nl.jorisdormans.graph.GraphConnection) : void
      {
         if(!this.outputs)
         {
            return;
