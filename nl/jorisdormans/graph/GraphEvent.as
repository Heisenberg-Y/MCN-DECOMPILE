package nl.jorisdormans.graph
{
   ...
   public class GraphEvent extends Event
   {
      ...
      public static const CSV_LOADED:String = "element_csv_attr_change";
      ...
      public var element:nl.jorisdormans.graph.GraphElement;
      
      public var message:String;
      
      public function GraphEvent(param1:String, param2:nl.jorisdormans.graph.GraphElement = null, param3:String = "")
      {
         super(param1);
         this.element = param2;
         this.message = param3;
