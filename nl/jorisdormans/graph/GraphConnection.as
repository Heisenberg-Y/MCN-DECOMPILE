...
import nl.jorisdormans.utils.MathUtil;
   ...
   public class GraphConnection extends nl.jorisdormans.graph.GraphElement
   {
      ...
      private var _start:nl.jorisdormans.graph.GraphElement;
      
      private var _end:nl.jorisdormans.graph.GraphElement;
      
      public var type:nl.jorisdormans.graph.GraphConnectionType;
      ...
      public function get start() : nl.jorisdormans.graph.GraphElement
      {
         return this._start;
      }
      
      public function set start(param1:nl.jorisdormans.graph.GraphElement) : void
      {
         if(this._start)
         {
      ...
      public function get end() : nl.jorisdormans.graph.GraphElement
      {
         return this._end;
      }
      
      public function set end(param1:nl.jorisdormans.graph.GraphElement) : void
      {
         if(this._end)
         {
