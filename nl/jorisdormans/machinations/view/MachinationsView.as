...
public class MachinationsView extends PhantomBorder
   {
      ...
      protected var _elements:Vector.<nl.jorisdormans.machinations.view.MachinationsViewElement>;
      ...
      public function MachinationsView(param1:DisplayObjectContainer, param2:Number, param3:Number, param4:Number, param5:Number)
      {
         ...
         this._elements = new Vector.<nl.jorisdormans.machinations.view.MachinationsViewElement>();
         this.createControls();
      ...
      protected function onMouseMoveView(param1:MouseEvent) : void
      {
         ...
         var _loc2_:nl.jorisdormans.machinations.view.MachinationsViewElement = this.getElementAt(param1.localX,param1.localY);
         var _loc3_:nl.jorisdormans.machinations.view.MachinationsViewElement = null;
         if(_loc2_)
         {
            if(_loc2_.pinsOnly)
            {
      ...
      public function get hover() : nl.jorisdormans.machinations.view.MachinationsViewElement
      {
         return this._hover;
      }
      
      public function set hover(param1:nl.jorisdormans.machinations.view.MachinationsViewElement) : void
      {
         if(this._hover)
         {
      ...
      {
         this._elements.push(new nl.jorisdormans.machinations.view.MachinationsViewElement(this.drawPanel,param1.element));
      ...
      public function getElementAt(param1:Number, param2:Number, param3:nl.jorisdormans.machinations.view.MachinationsViewElement = null) : nl.jorisdormans.machinations.view.MachinationsViewElement
      {
         var _loc4_:int;
      ...
      public function removeElement(param1:nl.jorisdormans.machinations.view.MachinationsViewElement) : void
      {
      ...
      public function pushToTop(param1:nl.jorisdormans.machinations.view.MachinationsViewElement) : void
      {
         var _loc2_:int = int(this._elements.length);
         var _loc3_:int = 0;
      ...
      private function onWarning(param1:GraphEvent) : void
      {
         ...
         this.popup = new nl.jorisdormans.machinations.view.PopUp(stage,(600 - 300) * 0.5,100,"Warning!",param1.message);
      }
      ...
      private function onError(param1:GraphEvent) : void
      {
         ...
         this.popup = new nl.jorisdormans.machinations.view.PopUp(stage,(600 - 300) * 0.5,100,"Error!",param1.message);
      }
   }
}
