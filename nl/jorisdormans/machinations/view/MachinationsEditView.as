package nl.jorisdormans.machinations.view
{
   ...
   public class MachinationsEditView extends MachinationsView
   {
      ...
      private var _lastSelected:nl.jorisdormans.machinations.view.MachinationsViewElement;
      ...
      private var multiSelector:nl.jorisdormans.machinations.view.MultiSelector;
      
      private var dragging:Boolean = false;
      
      private var _activePanel:PhantomPanel;
      
      private var editElement:nl.jorisdormans.machinations.view.EditElementPanel;
      
      private var editConnection:nl.jorisdormans.machinations.view.EditConnectionPanel;
      
      private var editNode:nl.jorisdormans.machinations.view.EditNodePanel;
      
      private var editRegister:nl.jorisdormans.machinations.view.EditRegisterPanel;
      
      private var editDelay:nl.jorisdormans.machinations.view.EditDelayPanel;
      
      private var editEnd:nl.jorisdormans.machinations.view.EditNodePanel;
      
      private var editSource:nl.jorisdormans.machinations.view.EditSourcePanel;
      
      private var editPool:nl.jorisdormans.machinations.view.EditSourcePanel;
      
      private var editGate:nl.jorisdormans.machinations.view.EditGatePanel;
      
      private var editLabel:nl.jorisdormans.machinations.view.EditLabelPanel;
      
      private var editChart:nl.jorisdormans.machinations.view.EditChartPanel;
      
      private var editAP:nl.jorisdormans.machinations.view.EditAPPanel;
      
      private var editGraph:nl.jorisdormans.machinations.view.EditGraphPanel;
      ...
      override protected function createControls() : void
      {
         ...
         this.editElement = new nl.jorisdormans.machinations.view.EditElementPanel(this,parent,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editConnection = new nl.jorisdormans.machinations.view.EditConnectionPanel(this,parent,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editNode = new nl.jorisdormans.machinations.view.EditNodePanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editRegister = new nl.jorisdormans.machinations.view.EditRegisterPanel(this,parent,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editDelay = new nl.jorisdormans.machinations.view.EditDelayPanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editEnd = new nl.jorisdormans.machinations.view.EditNodePanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false,true,false);
         this.editSource = new nl.jorisdormans.machinations.view.EditSourcePanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editPool = new EditPoolPanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editGate = new nl.jorisdormans.machinations.view.EditGatePanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editLabel = new nl.jorisdormans.machinations.view.EditLabelPanel(this,parent,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editChart = new nl.jorisdormans.machinations.view.EditChartPanel(this,parent,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
         this.editAP = new nl.jorisdormans.machinations.view.EditAPPanel(this,parent,stage,_controlWidth + x,_loc2_,editPanelWidth,_loc8_,false);
      ...
      private function importData(param1:PhantomButton) : void
      {
         ...
         this.fileIOData.openFileDialog("Import File", "csv files: (*.csv)|*.csv");
      }
      ...
      {
         var _loc6_:nl.jorisdormans.machinations.view.MachinationsViewElement = null;
         var _loc2_:XML = <svg/>;
         ...
         while(_loc5_ < _loc4_)
         {
            if(_loc6_ = drawPanel.getChildAt(_loc5_) as nl.jorisdormans.machinations.view.MachinationsViewElement)
            {
      ...
      private function onMouseMove(param1:MouseEvent) : void
      {
         ...
         var _loc4_:nl.jorisdormans.machinations.view.MachinationsViewElement;
      ...
      public function set activePanel(param1:PhantomPanel) : void
      {
         ...
         if(this._activePanel)
         {
            ...
            if(Boolean(this._lastSelected) && this._activePanel is nl.jorisdormans.machinations.view.EditElementPanel)
            {
               (this._activePanel as nl.jorisdormans.machinations.view.EditElementPanel).element = this._lastSelected.element;
            }
            if(this._activePanel is nl.jorisdormans.machinations.view.EditGraphPanel)
            {
               (this._activePanel as nl.jorisdormans.machinations.view.EditGraphPanel).graph = this.graph;
            }
         }
      }
      
      public function get lastSelected() : nl.jorisdormans.machinations.view.MachinationsViewElement
      {
         return this._lastSelected;
      }
      
      public function set lastSelected(param1:nl.jorisdormans.machinations.view.MachinationsViewElement) : void
      {
      ...
      {
         var _loc2_:nl.jorisdormans.machinations.view.MachinationsViewElement = getElementAt(param1.localX,param1.localY);
      ...
      private function addConnectionPoint(param1:MouseEvent) : void
      {
         ...
         var _loc3_:nl.jorisdormans.machinations.view.MachinationsViewElement = getElementAt(param1.localX,param1.localY,this.lastSelected);
         if(_loc3_)
         {
         ...
         else
         {
            ...
            if((_loc6_ = _loc4_ * _loc4_ + _loc5_ * _loc5_) < nl.jorisdormans.machinations.view.MachinationsViewElement.CONTROL_SIZE * nl.jorisdormans.machinations.view.MachinationsViewElement.CONTROL_SIZE)
            {
      ...
      private function doSelect(param1:MouseEvent) : void
      {
         ...
         var _loc4_:nl.jorisdormans.machinations.view.MachinationsViewElement = getElementAt(_loc2_,_loc3_);
         ...
         else if(param1.target is PhantomDrawPanel)
         {
            ...
            {
               this.multiSelector = new nl.jorisdormans.machinations.view.MultiSelector();
            }
      ...
      override public function removeElement(param1:nl.jorisdormans.machinations.view.MachinationsViewElement) : void
      {
