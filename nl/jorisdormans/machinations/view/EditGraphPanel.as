package nl.jorisdormans.machinations.view
{
   ...
   public class EditGraphPanel extends PhantomPanel
   {
      ...
      private var view:nl.jorisdormans.machinations.view.MachinationsEditView;
      
      public function EditGraphPanel(param1:DisplayObjectContainer, param2:Stage, param3:nl.jorisdormans.machinations.view.MachinationsEditView, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean = true, param9:Boolean = true)
      {
