...
import nl.jorisdormans.utils.StringUtil;
   ...
   public class EditElementPanel extends PhantomPanel
   {
      ...
      protected var view:nl.jorisdormans.machinations.view.MachinationsEditView;
      ...
      public function EditElementPanel(param1:nl.jorisdormans.machinations.view.MachinationsEditView, param2:DisplayObjectContainer, param3:Number, param4:Number, param5:Number, param6:Number, param7:Boolean = true, param8:Boolean = true, param9:Boolean = false)
      {
         this.view = param1;
