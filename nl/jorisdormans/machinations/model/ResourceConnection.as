package nl.jorisdormans.machinations.model
{
   ...
   public class ResourceConnection extends MachinationsConnection
   {
      ...
      public var resources:Vector.<nl.jorisdormans.machinations.model.Resource>;
      ...
      public function produce(param1:Source) : void
      {
         ...
         while(_loc5_ < _loc2_)
         {
            this.resources.push(new nl.jorisdormans.machinations.model.Resource(_loc4_,_loc5_ * _loc3_));
            _loc5_++;
         }
      }
      ...
      public function pull(param1:int = 0) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if(_loc8_ < 16777216)
            {
               this.resources.push(new nl.jorisdormans.machinations.model.Resource(_loc8_,_loc4_ * _loc6_));
               ++this.justPulled;
            }
            if(_loc8_ == 16777216)
            {
