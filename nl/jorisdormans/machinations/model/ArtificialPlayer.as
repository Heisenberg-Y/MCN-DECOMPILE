package nl.jorisdormans.machinations.model
{
   ...
   public class ArtificialPlayer extends MachinationsNode
   {
      ...
      public var instructions:Vector.<nl.jorisdormans.machinations.model.APInstruction>;
      ...
      public function readInstructions() : void
      {
         ...
         this.instructions = new Vector.<nl.jorisdormans.machinations.model.APInstruction>();
         ...
         while(_loc2_ > 0)
         {
            ...
            if(_loc3_.length > 0)
            {
               this.instructions.push(new nl.jorisdormans.machinations.model.APInstruction(this,_loc1_));
            }
