package nl.jorisdormans.machinations.model
{
   ...
   public class Delay extends MachinationsNode
   {
      ...
      private var resources:Vector.<nl.jorisdormans.machinations.model.Resource>;
      
      private var output:nl.jorisdormans.machinations.model.ResourceConnection;
      ...
      public function Delay()
      {
         super();
         size = 12;
         this.resources = new Vector.<nl.jorisdormans.machinations.model.Resource>();
      ...
      override public function prepare(param1:Boolean) : void
      {
         ...
         {
            if(outputs[_loc2_] is nl.jorisdormans.machinations.model.ResourceConnection)
            {
               this.output = outputs[_loc2_] as nl.jorisdormans.machinations.model.ResourceConnection;
            }
            _loc2_++;
         }
      ...
      override public function receiveResource(param1:uint, param2:nl.jorisdormans.machinations.model.ResourceConnection) : void
      {
         var _loc3_:nl.jorisdormans.machinations.model.Resource = null;
         var _loc4_:int = 0;
         var _loc5_:nl.jorisdormans.machinations.model.ResourceConnection = null;
         ...
         if((graph as MachinationsGraph).colorCoding == 1)
         {
            ...
            {
               if((Boolean(_loc5_ = outputs[_loc4_] as nl.jorisdormans.machinations.model.ResourceConnection)) && _loc5_.color == param1)
               {
                  _loc5_.label.generateNewValue();
                  _loc6_ = _loc5_.label.value + this.inputStateValue;
                  _loc3_ = new nl.jorisdormans.machinations.model.Resource(param1,_loc6_);
            ...
            if(!_loc3_)
            {
               ...
               while(_loc4_ < outputs.length)
               {
                  if((Boolean(_loc5_ = outputs[_loc4_] as nl.jorisdormans.machinations.model.ResourceConnection)) && _loc5_.color == this.color)
                  {
                     _loc5_.label.generateNewValue();
                     _loc6_ = _loc5_.label.value + this.inputStateValue;
                     _loc3_ = new nl.jorisdormans.machinations.model.Resource(param1,_loc6_);
      ...
      public function changeState(param1:uint, param2:int) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if(outputs[_loc4_] is nl.jorisdormans.machinations.model.ResourceConnection)
            {
               (outputs[_loc4_] as nl.jorisdormans.machinations.model.ResourceConnection).checkInhibition(true);
            }
            _loc4_++;
         }
         if(param2 != 0)
