package nl.jorisdormans.machinations.model
{
   ...
   public class Pool extends Source
   {
      ...
      public function set startingResources(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            this.resources.push(new nl.jorisdormans.machinations.model.Resource(this.resourceColor,0));
            _loc2_++;
         }
      }
      ...
      override public function set resourceColor(param1:uint) : void
      {
         ...
         {
            this.resources.push(new nl.jorisdormans.machinations.model.Resource(param1,0));
            _loc2_++;
         }
      }
