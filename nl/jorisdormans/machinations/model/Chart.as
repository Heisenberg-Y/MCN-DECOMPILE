package nl.jorisdormans.machinations.model
{
   ...
   public class Chart extends GroupBox
   {
      ...
      private var _data:Vector.<nl.jorisdormans.machinations.model.ChartData>;
      ...
      {
         this._data = new Vector.<nl.jorisdormans.machinations.model.ChartData>();
         this._scaleY = 12;
         this._scaleX = 20;
         this._negScaleY = 0;
      ...
      override public function prepare(param1:Boolean) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            {
               this._data.push(new nl.jorisdormans.machinations.model.ChartData(inputs[_loc3_] as StateConnection,this._highLighted));
            }
            _loc3_++;
         }
      }
