package nl.jorisdormans.machinations.model
{
   ...
   public class APInstruction
   {
      ...
      private var artificialPlayer:nl.jorisdormans.machinations.model.ArtificialPlayer;
      
      public function APInstruction(param1:nl.jorisdormans.machinations.model.ArtificialPlayer, param2:String)
      {
      ...
      private function activateAP() : void
      {
         ...
         if(this.parameters.length > 0 && Boolean(_loc1_))
         {
            ...
            ++this.counter;
            this.counter %= this.parameters.length;
            if(_loc2_ is nl.jorisdormans.machinations.model.ArtificialPlayer)
            {
               (_loc2_ as nl.jorisdormans.machinations.model.ArtificialPlayer).activate();
            }
         }
         this.artificialPlayer.deactivate();
      }
