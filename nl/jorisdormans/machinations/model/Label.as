package nl.jorisdormans.machinations.model
{
   ...
   public class Label
   {
      ...
      public var connection:nl.jorisdormans.machinations.model.MachinationsConnection;
      ...
      public function Label(param1:nl.jorisdormans.machinations.model.MachinationsConnection, param2:Number, param3:String)
      {
         this.min = -LIMIT;
         super();
