package nl.jorisdormans.machinations.model
{
   ...
   public class ChartData
   {
      ...
      public var connection:nl.jorisdormans.machinations.model.StateConnection;
      
      public var name:String;
      
      public var run:int;
      
      public function ChartData(param1:nl.jorisdormans.machinations.model.StateConnection, param2:int)
      {
         super();
